	...
	return (
		<div>
			...
			<div className="absolute">
				<img
					className="object-cover h-screen md:object-none md:h-auto"
					src={BG_IMG_URL}
					alt="bg-img"
				/>
			</div>
			...
			<form
				...
				className="absolute left-0 right-0 p-12 m-4 text-white bg-black md:mx-auto md:w-3/12 bg-opacity-85 my-36"
				action="">
